...
// Class for Funk playlist
public class Funk implements MusicGenre {
    ...
    // Constructor to loop through each song in Funk playlist + submenu to run playlist or quit.
    public Funk() {
        // Stores music file paths in a Files array
        try {
            files[0] = new File("music_file/funk/DIA DELÍCIA - Nakama.wav");
            files[1] = new File("music_file/funk/FUNK DE METAIS.wav");
            files[2] = new File("music_file/funk/Kverz — PITA PITA.wav");
            files[3] = new File("music_file/funk/MONTAGEM ALUCINANTE - Rushex, Dj Orbital.wav");
            files[4] = new File("music_file/funk/RITMO DE VERAO.wav");
