...
// Class for HipHop playlist
public class HipHop implements MusicGenre {
    ...
    // Constructor to loop through each song in HipHop playlist + submenu to run playlist or quit.
    public HipHop() {
        // Stores music file paths in a Files array
        try {
            files[0] = new File("music_file/hiphop/679 - Fetty Wap, Monty.wav");
            files[1] = new File("music_file/hiphop/Juicy - The Notorious B.I.G.wav");
            files[2] = new File("music_file/hiphop/Lose Yourself - Eminem.wav");
            files[3] = new File("music_file/hiphop/Loyal - Chris Brown, Ft. Lil Wayne, Tyga.wav");
            files[4] = new File("music_file/hiphop/Shook Ones, Pt. II - Mobb Deep.wav");
