...
// Class for KPop playlist
public class KPop implements MusicGenre {
    ...
    // Constructor to loop through each song in KPop playlist + submenu to run playlist or quit.
    public KPop() {
        // Stores music file paths in a Files array
        try {
            files[0] = new File("music_file/k-pop/FIFTY FIFTY - Cupid.wav");
            files[1] = new File("music_file/k-pop/Girls Generation - Closer.wav");
            files[2] = new File("music_file/k-pop/LE SSERAFIM  - Perfect Night.wav");
            files[3] = new File("music_file/k-pop/TWICE - UP NO MORE.wav");
            files[4] = new File("music_file/k-pop/TXT - CAT & DOG.wav");
